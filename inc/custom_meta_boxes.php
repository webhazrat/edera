...
function meta_boxes(){
    ...
    add_meta_box('__section_name', __('Section'), 'custom_options', 'section', 'side', 'low', array( 
        'options' => ['Banner', 'Newsletter', 'Our Contact Vehicles & Certifications', 'Products', 'Who We Serve', 'Who We Serve Items', 'Media Contacts', 'Media Queries', 'Why We Exist', 'What it Means to Be a Low Profit LLC', 'How to Work with Us']
    ));
