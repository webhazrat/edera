        ...
        <div class="banner-item">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="banner-text">
                            <h2 class="section-header">Purpose Before Profit</h2>
                            <p>As a Low-Profit Limited Liability Company (L3C), Edera exists to help organizations build better businesses and effect positive change in society. Profits beyond the sustainability goals of our organizations are reinvested into our communities (e.g., community improvement initiatives) and/or our clients (e.g., indirect rate reinvestment or alignment).</p>
            ...
            <div class="text-end">
                <video autoplay="" muted="" loop="" id="video-banner">
                    <source src="<?php echo get_template_directory_uri(); ?>/assets/attachment/videos/Edera Header Howwegive 1440 530.mp4" type="video/mp4">
