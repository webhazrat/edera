        ...
        <div class="banner-item">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="banner-text">
                            <h2 class="section-header">Inspiring Innovation. <br> Catalyzing Change.</h2>
                            <p>Edera L3C is a mission-focused, low-profit health care consulting firm based in the District of Columbia. As the only firm in the United States to have successfully executed the unique strategy of combining industry experts with full-time creative, technology, and management consulting resources, we flex to bring you the expertise and capabilities needed to solve your most complex real-world challenges. With our holistic human-centered approach, best-in-class consulting protocols, industry-specific best practices, bespoke technological tools, and commitment to delivery excellence, Edera creates value that lasts.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="text-end">
                <video autoplay="" muted="" loop="" id="video-banner">
                    <source src="<?php echo get_template_directory_uri(); ?>/assets/attachment/videos/Edera Header Whoweare 1440 530.mp4" type="video/mp4">
